...
| Grafana admin password | Kubernetes Secret (auto-generated) + PVC-backed SQLite DB (`microk8s-hostpath`, 1Gi) | Not in Git; see [runbook.md](./runbook.md) to retrieve it. Persisted so it survives pod restarts — see [ADR-0012](./adr/0012-monitoring-stack.md) |
