...
This page is the map: components, what lives where, and the GitOps mechanism itself. See also:

- [`request-flows.md`](./request-flows.md) — how a request actually reaches a pod, for Ollama inference, the homelab-gateway path, and voice mode
- [`operations.md`](./operations.md) — GPU monitoring and host-routed ingress
- [`runbook.md`](./runbook.md) — operational tasks and troubleshooting
- [`testing.md`](./testing.md) — how the stack is verified
